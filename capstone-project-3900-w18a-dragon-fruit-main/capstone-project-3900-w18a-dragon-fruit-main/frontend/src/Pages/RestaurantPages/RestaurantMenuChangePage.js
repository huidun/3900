...
export default function RestaurantMenuChangePage() {
    ...
    React.useEffect(() => {
        axios.get(`http://127.0.0.1:8000/restaurant/menu/dish/details`, {
            params: {
                id,
            },})
            .then((response) => {
    ...
    const SubmitRequest = async () => {
        ...
        await axios.put('http://127.0.0.1:8000/restaurant/menu/dish/edit', JSON.stringify(body),
            {
                headers:{
